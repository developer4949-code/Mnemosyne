...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("message_roles", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
    ...
    op.create_table(
        ...
        sa.Column("project_id", sa.String(length=64), sa.ForeignKey("projects.id"), nullable=False),
        sa.Column("conversation_id", sa.String(length=64), sa.ForeignKey("conversations.id"), nullable=False),
        sa.Column("chunk_id", sa.String(length=128), sa.ForeignKey("chunks.id"), nullable=False),
        sa.Column("kind", sa.String(length=64), nullable=False),
        sa.Column("text", sa.Text(), nullable=False),
        sa.Column("importance", sa.Float(), nullable=False),
        sa.Column("confidence", sa.Float(), nullable=False),
        sa.Column("embedding", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("source_message_ids", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
    ...
    op.create_table(
        "project_dna",
        sa.Column("project_id", sa.String(length=64), sa.ForeignKey("projects.id"), primary_key=True),
        sa.Column("dna", sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), onupdate=sa.func.now(), nullable=False),
    )

...
async def test_delete_project_coordinates_vector_and_db_cleanup() -> None:
    ...
    with patch("services.project.ProjectRepository") as mock_repo_cls, \
         patch("memory_engine.retrieval.vector_store.QdrantVectorStore") as mock_vector_cls:
        ...
        mock_vector.delete_memories_by_project.assert_called_once_with("test-project-123")

...
from api.v1 import health, memory
...
# Future v1 routes — uncomment as each milestone adds them:
# from api.v1 import auth, projects, conversations, memory, retrieval, providers
